...
known_image = face_recognition.load_image_file("C:\\Users\\Shiva Goud\\Desktop\\INFOSYS SPRING BOARD\\Face_Recognition\\Barak Obama\\Face_Recognition\\Barak Obama.jpg")
known_faces = face_recognition.face_encodings(known_image, num_jitters=50, model='large')[0]

# Launch the live camera
cam = cv.VideoCapture("C:\\Users\\Shiva Goud\\Desktop\\INFOSYS SPRING BOARD\\Face_Recognition\\Barak Obama\\Face_Recognition\\1000097197.mp4")
    ...
    for face_encoding in face_encodings:
        ...
        if distance < confidence_threshold:  # Check if the distance is below the threshold
            ...
            for face_location in face_locations:
                ...
                frame = cv.putText(frame, 'Barack Obama', (left, top - 10), cv.FONT_HERSHEY_SIMPLEX, 0.5,
                                   (255, 0, 0), 2, cv.LINE_AA)

    if not recognized:
        frame = cv.putText(frame, 'Not Barack Obama', (30, 55), cv.FONT_HERSHEY_SIMPLEX, 1,
                           (255, 0, 0), 2, cv.LINE_AA)
